...
type FundTransOrderQueryResp struct {
	...
	RawResp json.RawMessage `json:"alipay_fund_trans_order_query_response"`
	Sign    string          `json:"sign"` // 签名
}

func (r *FundTransOrderQueryResp) GetSubCode() string {
	return r.Resp.SubCode
}

func (r *FundTransOrderQueryResp) IsSuccess() bool {
	return r.Resp.SubCode == ""
}

func (r *FundTransOrderQueryResp) GetSign() string {
	return r.Sign
}

func (r *FundTransOrderQueryResp) GetRawParams() string {
